...
<div>
    ...
    <form action = "/lecturer/notes/upload" method = "POST" class = "p-8" enctype="multipart/form-data">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input name = "file" type = "file" id="file" class = "appearance-none bg-gray-100 rounded w-full h-10 py-2 px-3 text-gray-700 leading-tight focus:outline-green-100">
